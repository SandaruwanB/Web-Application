            ...
            <div class="nav">
                <ul>
                    ...
                    <li style="background-color: #fff;">
                        <a href="admininventry.php" style="color: #2a2185;font-weight: bold;">
                            ...
                            if($result)
                            {
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    echo '<tr>
                                        ...
                                        <td data-label="Expire Date">'.$value.'</td>
                                        <td data-label="Action"><a href="editItem.php?inId='.$id.'"><button class="edit">Edit</button></a>&nbsp;&nbsp; <a href="delete.php?inId='.$id.'"><button class="delete">Delete</button></a></td>
                                    </tr>';
                                }
                            }
                        ?>
